    ...
    <main className="about">
      ...
      <section>
        ...
        <p>
          ...
          guess the names of video games instead of words. Whether you're a
          casual gamer or a hardcore aficionado, Ludole offers a fun and
          engaging way to test your video game knowledge and discover new
          titles.
        </p>
        ...
        <p>
          ...
          together to create a unique and enjoyable gaming experience. Our
          mission is to bring the gaming community closer through fun puzzles.
        </p>
        <h3>Charles Kwang</h3>
        <p>
          ...
          Combining coding and art, Charles uses his unique background to
        ...
        <p>
          ...
          increasing knowledge in webapp frameworks like Node.js and React! I
          have a background as an artist, graduating with a bachelors in fine
          arts with an illustration focus. As a result I naturally gravitated
          towards front end projects and creating fresh but intuitive user
          experiences in software. I also have a love of oddball low-power,
          purpose-built electronics and an obsession with optimization.
          Currently I stick to interfacing with pre-built libraries with devices
          like raspberry pis, but I hope to continue building on my existing
          knowledge by moving into lower level understanding as I put more
